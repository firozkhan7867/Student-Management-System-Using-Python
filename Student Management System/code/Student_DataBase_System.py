...
class Student(object):
    ...
    def Admin_page(self):
        ...
        back_button = Button(main_frame, text="<--  Back",
                             bg="PowderBlue", font=30, command=back)
        ...
        user_id_label = Label(main_frame, text="user id",
    ...
    def project(self):
        ...
        def wiki():
            ...
            Wiki_label = Label(n1_frame, text="wikipedia..",
                               bg="teal", font=40)
    ...
    def keys(self):
        ...
        def click():
            ...
            if g == key:
                messagebox.showinfo(
                    "success ,,,!!", "valid key entered for verification")
                k.destroy()
                self.root.destroy()
            else:
                messagebox.showerror(
                    "ERROR ,,,!!", "Invalid key entered for verification")
                self.root.destroy()
                k.destroy()
    ...
    def login(self):
        ...
        def click():
            ...
            if con == True:
                ...
                messagebox.showerror(
                    "Error", "Invalid  User name Or Pass word!!!")
                #import sys
                #sys.exit()
                self.root.destroy()
